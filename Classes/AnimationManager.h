...
public:
    ...
    static void addAnimationCache(string path, string cacheName, int startNum, int endNum, float delay);
    static void addAnimationCacheWalk4(string path, string cacheName, int startNum, float delay);
